          ...
          <div class="page-header">
            <div class="row align-items-end">
              <div class="col-sm mb-2 mb-sm-0">
                ...
                <h1 class="page-header-title">Add Subscribtion</h1>
              </div>
          ...
          <div id="addUserStepFormContent">
            ...
            <div id="addUserStepProfile" class="card card-lg active">
              ...
              <div class="card-body">
                ...
                <div class="row mb-4">
                  <label for="emailLabel" class="col-sm-3 col-form-label form-label">Duration</label>
                  <div class="col-sm-9">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <textarea type="number" class="form-control" name="amount" id="emailLabel"
      ...
      <div class="col-6">
        <div class="form-check form-check-label-highlighter text-center">
          ...
          <label class="form-check-label mb-2" for="navbarLayoutSkinsRadio1">
            <img class="form-check-img" src="assets/svg/layouts-light/sidebar-default.svg" alt="Image Description"
              data-hs-theme-appearance="dark">
            <img class="form-check-img" src="assets/svg/layouts/sidebar-default.svg" alt="Image Description"
      ...
      <div class="col-6">
        <div class="form-check form-check-label-highlighter text-center">
          ...
          <label class="form-check-label mb-2" for="navbarLayoutSkinsRadio2">
            <img class="form-check-img" src="assets/svg/layouts-light/sidebar-dark.svg" alt="Image Description"
              data-hs-theme-appearance="dark">
            <img class="form-check-img" src="assets/svg/layouts/sidebar-dark.svg" alt="Image Description"
              data-hs-theme-appearance="default">
          </label>
      ...
      <div class="col-6">
        <div class="form-check form-check-label-highlighter text-center">
          ...
          <label class="form-check-label mb-2" for="sidebarNavOptions2">
            <img class="form-check-img" src="assets/svg/layouts-light/demo-layouts-nav-tabs.svg" alt="Image Description"
              data-hs-theme-appearance="dark">
            <img class="form-check-img" src="assets/svg/layouts/demo-layouts-nav-tabs.svg" alt="Image Description"
              data-hs-theme-appearance="default">
          </label>
      ...
      <div class="col-6">
        <div class="form-check form-check-label-highlighter text-center">
          ...
          <label class="form-check-label mb-2" for="headerLayoutOptions1">
            <img class="form-check-img" src="assets/svg/layouts/header-default-container.svg" alt="Image Description"
              data-hs-theme-appearance="default">
            ...
            <div class="navbar-nav-wrap-content-end">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                  <!-- Apps -->
                  <div class="dropdown">
                    <button type="button" class="btn btn-icon btn-ghost-light rounded-circle" id="navbarAppsDropdown"
                      data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation>
                      <i class="bi-app-indicator"></i>
                    </button>
