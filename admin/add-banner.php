...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    ...
    <!-- Step Form -->
    <form action="add-banner-db.php" method="post"  class="js-step-form py-md-5" enctype="multipart/form-data" data-hs-step-form-options='{
        ...
        <div class="col-lg-12">
          ...
          <div class="page-header">
            <div class="row align-items-end">
              <div class="col-sm mb-2 mb-sm-0">
                ...
                <h1 class="page-header-title">Add Banner</h1>
              </div>
          ...
          <div id="addUserStepFormContent">
            ...
            <div id="addUserStepProfile" class="card card-lg active">
              ...
              <div class="card-body">
                <div class="row mb-4">
                  <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Movie Name</label>
                  <div class="col-sm-9">
                    <div class="input-group input-group-sm-vertical">
                      <input type="text" class="form-control" name="movie-name" id="firstNameLabel"
                        placeholder="Movie Name">
                    </div>
                  </div>
                </div>
                <div class="row mb-4">
                  <label for="emailLabel" class="col-sm-3 col-form-label form-label">Banner Image</label>
