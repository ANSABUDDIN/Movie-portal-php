...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $result = mysqli_query($con, "DELETE FROM `series` WHERE id='$id'");
                    ...
                    <div class="page-header">
                        <div class="row align-items-end">
                            <div class="col-sm mb-2 mb-sm-0">
                                <h1 class="page-header-title">Series</h1>
                            </div>
                            <div class="col-sm-auto">
                                <a class="btn btn-primary" href="add-series.php">
                                    <i class="bi-book me-1"></i> Add Series
                                </a>
                            </div>
                        </div>
                        <!-- End Row -->
                      ...
                      <input id="datatableSearch" type="search" class="form-control" placeholder="Search users"
                        aria-label="Search series">
                           ...
                           "pagination": "datatablePagination"
                                    ...
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th class="table-column-ps-0">Series Title</th>
                                            <th>Total Season</th>
                                            <th>Image</th>
                                            <th>veiw Details</th>
                                            <th>Action</th>
                                    ...
                                    <tbody>
                                        <?php $Series = mysqli_query($con, "select * from series");
                                        foreach ($Series as  $SeriesDEtail) {
                                            $Series_id = $SeriesDEtail['id'];
                                            // $cheak_season = mysqli_query($con, "select season from episode where series_id='$Series_id'");
                                            $cheak_season = mysqli_query($con, "select DISTINCT  season from episode where series_id='$Series_id'");
                                        ?>
                                            <tr>
                                                <td>
                                                    <?php echo $Series_id; ?>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="d-block fs-5 text-body"><?php echo mysqli_num_rows($cheak_season); ?></span>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="avatar avatar-circle">
                                                        <img class="avatar-img w-100" src="<?php echo " ../" . $SeriesDEtail['image']; ?>" alt="Image
                          Description">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-white btn-sm" data-bs-toggle="modal" data-bs-target="#editUserModal<?php echo $SeriesDEtail['id']; ?>">
                                                        veiw
                                                    </button>
                                                </td>
                          ...
                          Edit
                                                    ...
                                                    <a href="?delete=<?php echo $SeriesDEtail['id']; ?>" class="btn btn-danger btn-sm">
                                                        <i class="bi bi-trash-fill"></i>
                                                    </a>
                                                   
                                                    <a href="episode.php?series=<?php echo $SeriesDEtail['id']; ?>&&season=1" class="btn btn-danger btn-sm">
                                                        Add Episode
                                                    </a>
...
foreach ($Series as $GetSeries) { ?>
    <div class="modal fade" id="editUserModal<?php echo $GetSeries['id']; ?>" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editUserModalLabel">Series Details</h5>
                        ...
                        <ul class="js-tabs-to-dropdown nav nav-segment nav-fill mb-5" id="editUserModalTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="#profile" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" role="tab" aria-selected="true">
                                    <i class="bi-person me-1"></i> Series Details
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="tab-content" id="editUserModalTabContent">
                        <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <form>
                                ...
                                <div class="profile-cover">
                                    <div class="profile-cover-img-wrapper">
                                        <img id="editProfileCoverImgModal" class="profile-cover-img" src="../<?php echo $GetSeries['image']; ?>" alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Profile Cover -->
                                ...
                                <label class="avatar avatar-xxl avatar-circle avatar-uploader profile-cover-avatar mb-5" for="editAvatarUploaderModal">
                                    <img id="editAvatarImgModal" class="avatar-img" src="../<?php echo $GetSeries['image']; ?>" alt="Image Description">
                                </label>
                                <!-- End Avatar -->

                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="editFirstNameModalLabel" class="col-sm-3 col-form-label form-label">Series Title <i class="tio-help-outlined text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Displayed on public forums, such as Front."></i></label>

                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-vertical">
                                            <input type="text" class="form-control" name="editFirstNameModal" disabled id="editFirstNameModalLabel" placeholder="Your first name" aria-label="Your first name" value="<?php echo $GetSeries['title']; ?>">
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="editEmailModalLabel" class="col-sm-3 col-form-label form-label">Series Description</label>

                                    <div class="col-sm-9 ">
                                        <div class="form-control">

                                            <?php echo $GetSeries['description']; ?>
                                        </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="editOrganizationModal" disabled id="editOrganizationModalLabel" placeholder="Your organization" aria-label="Your organization" value="<?php echo $GetSeries['director_name']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="editOrganizationModalLabel" class="col-sm-3 col-form-label form-label">Series Star</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="editOrganizationModal" disabled id="editOrganizationModalLabel" placeholder="Your organization" aria-label="Your organization" value="<?php echo $GetSeries['series_star']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="editOrganizationModalLabel" class="col-sm-3 col-form-label form-label">Release year</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="editOrganizationModal" disabled id="editOrganizationModalLabel" placeholder="Your organization" aria-label="Your organization" value="<?php echo $GetSeries['release_year']; ?>">
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="tab-pane fade" id="billing-address" role="tabpanel" aria-labelledby="billing-address-tab">
                            <form>
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <label for="editAddressLine1Label" class="col-sm-3 col-form-label form-label">Series Link
                                            ?</label>
                                    </div>
                                    <div class="col-12">
                                        <input type="text" class="form-control" name="addressLine1" disabled id="editAddressLine1Label" aria-label="Your address" value="<?php echo $GetSeries['series_link']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <label for="editAddressLine1Label" class="col-sm-3 col-form-label form-label">Series Download Link
                                        </label>
                                    </div>
                                    <div class="col-12">
                                        <input type="text" class="form-control" name="addressLine1" disabled id="editAddressLine1Label" aria-label="Your address" value="<?php echo $GetSeries['download_link']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <label for="editAddressLine1Label" class=" col-form-label form-label">Series Trailer Link</label>
                                    </div>
                                    <div class="col-12">
                                        <input type="text" class="form-control" name="addressLine1" disabled id="editAddressLine1Label" aria-label="Your address" value="<?php echo $GetSeries['trailer']; ?>">
                                    </div>
                                </div>
