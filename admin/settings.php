...
if(isset($_POST['approve']))
    {
        $result = mysqli_query($con,"UPDATE admin SET `wallet`='".$_POST['wallet']."' WHERE id='1'");
        $_SESSION['message'] = " Wallet Updated Successfully";   

    }
  $wallet ="";
  $row=mysqli_query($con,"select * from admin");
  if($row)
  {
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
      ...
      <?php if(isset($_SESSION['message'])){?>
        ...
        <?php } ?>
      <form action="" method="post" class="js-step-form py-md-5" data-hs-step-form-options='{
      ...
      <div class="row align-items-end">
        <div class="col-sm mb-2 mb-sm-0">
          ...
          <h1 class="page-header-title">Account Setting </h1>
        </div>
            ...
            <div id="addUserStepFormContent">
              ...
              <div id="addUserStepProfile" class="card card-lg active">
                ...
                <div class="card-body">
                  ...
                  <div class="row mb-4">
                    <label for="emailLabel" class="col-sm-3 col-form-label form-label">Wallet Address :</label>

                    <div class="col-sm-9">
                      <input type="text"
                       class="form-control" name="wallet" id="emailLabel" placeholder="Wallet Address"
                       value="<?php echo $wallet; ?>" >
                    </div>
                  </div>
                </div>
                <!-- End Body -->
                ...
                <div class="card-footer d-flex justify-content-end align-items-center">
                  <input type="submit" name="approve" class="btn btn-primary" data-hs-step-form-next-options='{
