...
<!-- Mirrored from htmlstream.com/front-dashboard/authentication-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Sep 2022 12:54:55 GMT -->
<head>
    ...
    <div class="container py-5 py-sm-7">
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="card card-lg mb-5">
          <div class="card-body">
            <!-- Form -->
            <form  action="login-db.php" method="POST" class="js-validate needs-validation" novalidate>
              ...
              <div class="mb-4">
                ...
                <div class="input-group input-group-merge" data-hs-validation-validate-class>
                  <input type="password" class="js-toggle-password form-control form-control-lg"
                   name="password" id="signupSrPassword" placeholder="password" aria-label="8+ characters required" required minlength="8" data-hs-toggle-password-options='{
