...
if (isset($_GET['delete'])) {
  $id = $_GET['delete'];
  $result = mysqli_query($con, "DELETE FROM `episode` WHERE id='$id'");
...
if (isset($_GET['series'])) {
  ...
  $detail = mysqli_query($con, "select * from series where id='$series_id'");
  foreach ($detail as $getdetail) {
    $series_name = $getdetail['title'];
  }
            ...
            <div class="page-header">
              <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                  ...
                  <h1 class="page-header-title" style="text-transform: capitalize;"><?php echo $series_name ." Season " .$season_name ?> Episodes</h1>
                </div>
                <div class="col-sm-auto">
                  <a class="btn btn-primary" href="add-episode.php?series=<?php echo $series_id ?>">
                    <i class="bi-book me-1"></i> Add Episode
                  </a>
                </div>
              </div>
              <div class="row align-items-end">
                ...
                foreach ($season as $GETseason) { ?>
                  <div class="col-lg-2 col-12 mt-3 px-0 d-flex justify-content-center">
                    <a href="episode.php?series=<?php echo $series_id ?>&&season=<?php echo $GETseason['season'];  ?>" class="btn btn-primary  w-100 mx-3 ">
              ...
              <div class="col-sm-auto">
                <!-- <a class="btn btn-primary" href="add-ads.php">
                    <i class="bi-book me-1"></i> Add Episode
                  </a> -->
              </div>
            </div>
              ...
              <div class="table-responsive datatable-custom position-relative">
                ...
                <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                  ...
                  <thead class="thead-light">
                    <tr>
                      <th class="">id</th>
                      <th class="table-column-ps-0">Episode name</th>
                      <th>Image</th>
                      <th>Season</th>
                      <th>Date</th>
                      <th>Action</th>
                ...
                if (mysqli_num_rows($movie) > 0) {
                    foreach ($movie as $GETmovie) { ?>
                      <tr>
                        <td><?php echo $GETmovie['id']; ?></td>
                        <td><?php echo $GETmovie['title']; ?></td>
                        </td>
                        <td>

                          <div class="avatar avatar-circle">
                            <img class="avatar-img w-100" src="<?php echo "../" . $GETmovie['image']; ?>" alt="Image Description">

                          </div>
                        </td>
                        <td>
                          <span class="d-block fs-5 text-body"><?php echo $GETmovie['season']; ?></span>
                        </td>
                        <td>
                          <span class="d-block fs-5 text-body"><?php echo $GETmovie['date']; ?></span>
                        </td>
                        ...
                        <td>
                          ...
                          <a href="?delete=<?php echo $adsDEtail['id']; ?>" class="btn btn-danger btn-sm">
