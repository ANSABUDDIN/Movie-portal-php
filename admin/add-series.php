...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    ...
    <!-- Step Form -->
    <form action="add-series-db.php" method="post" class="js-step-form py-md-5" enctype="multipart/form-data" data-hs-step-form-options='{
        ...
        <div class="col-lg-12">
          ...
          <div class="page-header">
            <div class="row align-items-end">
              <div class="col-sm mb-2 mb-sm-0">
                ...
                <h1 class="page-header-title">Add Series</h1>
              </div>
          ...
          <div id="addUserStepFormContent">
            ...
            <div id="addUserStepProfile" class="card card-lg active">
              ...
              <div class="card-body">
                <div class="row mb-4">
                  <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Series Title</label>
                  <div class="col-sm-9">
                    <div class="input-group input-group-sm-vertical">
                      <input type="text" class="form-control" name="title" id="firstNameLabel" placeholder="Series Title">
                    </div>
                  </div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                  <label for="emailLabel" class="col-sm-3 col-form-label form-label">Series Star</label>

                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="series_star" id="emailLabel" placeholder="Series star">
                  </div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                  <label for="emailLabel" class="col-sm-3 col-form-label form-label">Genra</label>
                  ...
                  <div class="col-sm-9">
                    <select class="form-control" name="genre">
                      ...
                      foreach ($genre as $getgenre) { ?>
                        ...
                        <option value="<?php echo $getgenre['name']; ?>">
                          <?php echo $getgenre['name']; ?>
                        </option>
                ...
                <div class="row mb-4">
                  <label for="emailLabel" class="col-sm-3 col-form-label form-label">Series Link</label>

                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="Series_link" id="emailLabel" placeholder="Series link">
                  </div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <select class="form-control" name="country">
                      <?php
                      $genre = mysqli_query($con, "select * from country");
                      foreach ($genre as $getgenre) { ?>
