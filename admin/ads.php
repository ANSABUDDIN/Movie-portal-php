...
include("../config.php"); 
    ...
    {
        $id = $_GET['delete'];
        $result = mysqli_query($con,"DELETE FROM `ads` WHERE id='$id'");
          ...
          <div class="page-header">
            <div class="row align-items-end">
              <div class="col-sm mb-2 mb-sm-0">
                ...
                <h1 class="page-header-title">Ads</h1>
              </div>
              <div class="col-sm-auto">
                <a class="btn btn-primary" href="add-ads.php">
                  <i class="bi-book me-1"></i> Add Ads
                </a>
              </div>
            </div>
            <!-- End Row -->
              ...
              <?php if(isset($_SESSION['message'])){?>
                ...
                <table id="datatable"
                  ...
                  <thead class="thead-light">
                    <tr>
                      <th class="">id</th>
                      <th class="table-column-ps-0">Ads name</th>
                      <th>Image</th>
                      <th>category</th>
                      <th>Date</th>
                      <th>Action</th>
                  ...
                  <tbody>
                    <?php $ads =mysqli_query($con,"select * from ads");
                    foreach($ads as  $adsDEtail){ ?>
                    <tr>
                      <td><?php echo $adsDEtail['id']; ?></td>
                      <td><?php echo $adsDEtail['title']; ?></td>
                      </td>
                      <td>

                        <div class="avatar avatar-circle">
                          <img class="avatar-img w-100"  src="<?php echo "../".$adsDEtail['image']; ?>" alt="Image Description">
               
                        </div>
                      </td>
                      <td>
                        <span class="d-block fs-5 text-body"><?php echo $adsDEtail['category']; ?></span>
                      </td>
                      <td>
                        <span class="d-block fs-5 text-body"><?php echo $adsDEtail['date']; ?></span>
                      </td>
